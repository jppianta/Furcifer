...
export default function languagePluginLoader(module) {
  return new Promise((resolve, reject) => {
    if (!isOnClient()) {
      reject('Pyodide should not be running on Node');
    }
    ...
    Promise.all([postRunPromise, dataLoadPromise]).then(() => resolve({ FS: Module.FS, FS_createPath: Module.FS_createPath, FS_createDataFile: Module.FS_createDataFile }));
